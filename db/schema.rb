...
ActiveRecord::Schema.define(version: 20170127073701) do
  ...
  create_table "subscriptions", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["lead_id", "list_id"], name: "index_subscriptions_on_lead_id_and_list_id", unique: true, using: :btree
    t.index ["status"], name: "index_subscriptions_on_status", using: :btree
  end
